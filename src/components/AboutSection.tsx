...
const Feature = ({ icon, title, description, delay = "0s" }: FeatureProps) => {
  return (
    ...
    >
      <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary/20 text-primary mb-3 sm:mb-4">
        {icon}
      </div>
      <h3 className="font-display text-xl sm:text-2xl text-foreground mb-2">{title}</h3>
